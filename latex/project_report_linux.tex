...
% for Windows "標楷體" font is default
%\setCJKmainfont{標楷體} %設定中文字體
% for Linux while install Texlive, fonts-moe-standard-kai is also installed
\setCJKmainfont{MoeStandardKai.ttf}
% for Windows "Times New Roman" font is default
%\newfontfamily\sectionef{Times New Roman}%設定英文字體
% for Linux "Nimbus Roman" font is default
